...
struct NewPostModel {
    ...
    static func makeNewPost() -> [NewPostModel] {
        var post = [NewPostModel]()

        post.append(NewPostModel(author: "Simona",
        ...
        post.append(NewPostModel(author: "Mavrik",
                            image: UIImage(named: "post4") ?? UIImage(),
                            description: "Hi Simona, look how high I got!",
                            likesCount: 333,
                            viewsCount: 350))

        post.append(NewPostModel(author: "Michael",
